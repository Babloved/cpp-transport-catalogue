...
namespace tc {
    ...
    public:
        ...
        [[nodiscard]] domain::Path::Distance GetDistanceBetweenStops(const domain::Stop *stop_src,
                                                                     const domain::Stop *stop_dst) const noexcept;
    ...
    private:
        void AddStopsDistances(const domain::Stop *stop_src,
